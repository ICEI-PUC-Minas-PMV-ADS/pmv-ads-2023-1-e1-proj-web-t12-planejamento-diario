...
function addTask() {
    ...
    if (task_quinta.name.trim() !== "") {
      // Obtém a lista de tarefas
      var taskList = JSON.parse(localStorage.getItem("task_quinta")) || [];
  
      // Adiciona a nova tarefa à lista
      taskList.push(task_quinta);
  
      // Salva a lista atualizada no localStorage
      localStorage.setItem("task_quinta", JSON.stringify(taskList));
