...
function addTask() {
    ...
    if (task_terca.name.trim() !== "") {
      // Obtém a lista de tarefas
      var taskList = JSON.parse(localStorage.getItem("task_terca")) || [];
  
      // Adiciona a nova tarefa à lista
      taskList.push(task_terca);
  
      // Salva a lista atualizada no localStorage
      localStorage.setItem("task_terca", JSON.stringify(taskList));
