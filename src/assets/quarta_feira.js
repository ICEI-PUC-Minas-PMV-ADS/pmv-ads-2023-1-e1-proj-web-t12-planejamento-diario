...
function addTask() {
    ...
    if (task_quarta.name.trim() !== "") {
      // Obtém a lista de tarefas
      var taskList = JSON.parse(localStorage.getItem("task_quarta")) || [];
  
      // Adiciona a nova tarefa à lista
      taskList.push(task_quarta);
  
      // Salva a lista atualizada no localStorage
      localStorage.setItem("task_quarta", JSON.stringify(taskList));
