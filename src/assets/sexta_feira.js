...
function addTask() {
    ...
    if (task_sexta.name.trim() !== "") {
      // Obtém a lista de tarefas
      var taskList = JSON.parse(localStorage.getItem("task_sexta")) || [];
  
      // Adiciona a nova tarefa à lista
      taskList.push(task_sexta);
  
      // Salva a lista atualizada no localStorage
      localStorage.setItem("task_sexta", JSON.stringify(taskList));
