...
function addTask() {
    ...
    if (task_sabado.name.trim() !== "") {
      // Obtém a lista de tarefas
      var taskList = JSON.parse(localStorage.getItem("task_sabado")) || [];
  
      // Adiciona a nova tarefa à lista
      taskList.push(task_sabado);
  
      // Salva a lista atualizada no localStorage
      localStorage.setItem("task_sabado", JSON.stringify(taskList));
